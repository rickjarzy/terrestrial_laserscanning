...
from TLSToolbox import gauss_helmert_model, calc_sphere
...
if __name__ == "__main__":
    ...
    parser.add_argument("filename", help="specify the path to the TLS data that should be processed")
    ...
    if args.filename:
        ...
        # if user hands a wrog value
        if args.number_of_epochs < 4:
            print("# ERROR - please insert a value bigger than %s - at least 4!!!!" % args.number_of_epochs)
        ...
        # if user input is correct
            ...
            # load TLS data
            sphere_data_1 = numpy.loadtxt(open(args.filename), delimiter=",")
            ...
            while N >= counter_ransac_loop:
                ...
                sphere_parameters, corrections, SIGMA_xx, sigma_0, fig, ax, status_det = gauss_helmert_model(sphere_data_1_subset, sphere_data_max_z,  fig, args.verbosity)
            ...
            #sphere_parameters, corrections, SIGMA_xx, sigma_0, fig, ax, status_det = gauss_helmert_model(consensus_set, sphere_data_max_z, fig, args.verbosity)
        ...
        print("# ERROR - no filename was handed ")
