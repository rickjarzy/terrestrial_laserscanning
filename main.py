...
if __name__ == "__main__":
    ...
    while EPSILON < fl_check:
        ...
        # Widerspruchsvektor
        w = ((x_1 + v_x_1 - x_0[0])*(x_1 - x_0[0]) + (y_1 + v_y_1 - x_0[1])*(y_1 - x_0[1]) + (z_1 + v_z_1 - x_0[2])*(z_1 - x_0[2]) - x_0[3]*r_1) / r_1
        ...
        if abs(numpy.linalg.det(N)) > EPSILON:
            ...
            ax.scatter3D([x_dach[0]], [x_dach[1]], [x_dach[2]], color='cyan', linewidths=0.5, label="calculated Center Point")
